        ...
        recentPostsQuery.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot: dataSnapshot.getChildren()) {
                    ...
                    Log.w("TAG", "loadP"+postSnapshot.getValue().toString());


                    Query recentPostsQuery1= mDatabase.child("Location").child(dataSnapshot.getValue().toString());
                    ...
                    recentPostsQuery1.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if(dataSnapshot!=null||dataSnapshot.getValue(com.project.ria.navimate.Location.class).getLatitude()!=null) {
                ...
                for(int i=0;i<locArrayList.size();i++)
                {
                    ...
                    markerOptions.position(new LatLng(Double.parseDouble(locArrayList.get(i).getLatitude()),Double.parseDouble(locArrayList.get(i).getLongitude())));
                    Log.i("TAG","array lat"+locArrayList.get(i).getLatitude());
                    // Setting custom icon for the marker
                    // Setting title for the infowindow
                    markerOptions.title(locArrayList.get(i).getUname());
                    markerOptions.snippet(locArrayList.get(i).getPhone());
